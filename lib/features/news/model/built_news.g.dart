...
class _$BuiltNews extends BuiltNews {
  ...
  _$BuiltNews._(
    ...
    if (date == null) {
      throw new BuiltValueNullFieldError('BuiltNews', 'date');
    }
    if (title == null) {
      throw new BuiltValueNullFieldError('BuiltNews', 'title');
    }
    if (excerpt == null) {
      throw new BuiltValueNullFieldError('BuiltNews', 'excerpt');
    }
    if (authorName == null) {
      throw new BuiltValueNullFieldError('BuiltNews', 'authorName');
    }
    if (authorImage == null) {
      throw new BuiltValueNullFieldError('BuiltNews', 'authorImage');
    }
    if (thumbnail == null) {
      throw new BuiltValueNullFieldError('BuiltNews', 'thumbnail');
    }
  }
